...
const descriptions: Record<EndpointName, string> = {
  ...
  pnl: "Returns focused wallet PnL data, using Zerion on EVM chains and Birdeye on Solana.",
  ...
  xSearch: "Searches recent X posts for a query and returns normalized posts plus author metrics.",
  xCountRecent: "Returns recent X post counts for a query grouped by minute, hour, or day.",
  xUserByUsername: "Looks up an X user profile by username and returns normalized user metrics.",
  xUserLikes: "Returns posts liked by an X user, accepting either a username or user id.",
  xUserFollowers: "Returns followers for an X user, accepting either a username or user id.",
  xKolVolume: "Analyzes volume and price movement around an X post that mentions a contract address, using the tweet timestamp as the event anchor.",
