...
export const providerRegistry: ProviderRecord[] = [
  ...
  { id: "codex", label: "Codex", category: "marketData", folder: "Market_data/LowCaps/Codex", env: ["CODEX_API_KEY"], endpoints: ["filterTokens", "tokenPoolInfo", "tokenPriceHistory", "holderAnalysis", "detailedTokenStats", "rateMyEntry"] },
  { id: "alchemy", label: "Alchemy", category: "marketData", folder: "Market_data/MidCapsAndMajors/Alchemy", env: ["ALCHEMY_API_KEY"], endpoints: ["tokenPriceHistory", "rateMyEntry"] },
  ...
  { id: "coinGecko", label: "CoinGecko", category: "marketData", folder: "Market_data/MidCapsAndMajors/CoinGecko", env: ["COINGECKO_PRO_API_KEY"], endpoints: ["tokenPoolInfo", "tokenPriceHistory", "marketOverview", "rateMyEntry"] },
