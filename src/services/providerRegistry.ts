...
export const providerRegistry: ProviderRecord[] = [
  ...
  { id: "bscGasFeed", label: "BSC Gas Feed", category: "chainInfra", folder: "DEX/Chain/BSC/GAS_FEED", env: ["ETHERSCAN_API_KEY"], endpoints: ["marketOverview"] },
  ...
  { id: "birdeye", label: "Birdeye", category: "marketData", folder: "Market_data/LowCaps/Birdeye", env: ["BIRDEYE_API_KEY"], endpoints: ["tokenPoolInfo", "tokenPriceHistory", "holderAnalysis", "marketOverview", "rateMyEntry", "pnl", "xKolVolume"] },
  { id: "dexScreener", label: "DEX Screener", category: "marketData", folder: "Market_data/LowCaps/DEX_Screener", env: [], endpoints: ["tokenPoolInfo", "tokenPriceHistory", "marketOverview", "rateMyEntry", "xKolVolume"] },
  ...
  { id: "geckoTerminal", label: "GeckoTerminal", category: "marketData", folder: "Market_data/LowCaps/GeckoTerminal", env: [], endpoints: ["tokenPoolInfo", "tokenPriceHistory", "marketOverview", "rateMyEntry", "xKolVolume"] },
  { id: "codex", label: "Codex", category: "marketData", folder: "Market_data/LowCaps/Codex", env: ["CODEX_API_KEY"], endpoints: ["filterTokens", "tokenPoolInfo", "tokenPriceHistory", "holderAnalysis", "detailedTokenStats", "rateMyEntry", "xKolVolume"] },
  { id: "alchemy", label: "Alchemy", category: "marketData", folder: "Market_data/MidCapsAndMajors/Alchemy", env: ["ALCHEMY_API_KEY"], endpoints: ["tokenPriceHistory", "rateMyEntry", "xKolVolume"] },
  ...
  { id: "coinGecko", label: "CoinGecko", category: "marketData", folder: "Market_data/MidCapsAndMajors/CoinGecko", env: ["COINGECKO_PRO_API_KEY"], endpoints: ["tokenPoolInfo", "tokenPriceHistory", "marketOverview", "rateMyEntry", "xKolVolume"] },
  ...
  { id: "goPlus", label: "GoPlus", category: "risk", folder: "Risk/GoPlus", env: [], endpoints: ["isScam", "fullAudit", "marketOverview", "rateMyEntry"] },
  { id: "honeypot", label: "Honeypot.is", category: "risk", folder: "Risk/Honeypot_is", env: [], endpoints: ["isScam", "fullAudit", "marketOverview", "rateMyEntry"] },
  ...
  { id: "xApi", label: "X API", category: "sentiment", folder: "Sentiment/LowCaps/X", env: ["X_BEARER_TOKEN"], endpoints: ["xSearch", "xCountRecent", "xUserByUsername", "xUserLikes", "xUserFollowers", "xKolVolume", "fudSearch", "marketOverview"] },
